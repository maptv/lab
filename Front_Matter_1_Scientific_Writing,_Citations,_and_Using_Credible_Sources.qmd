**Front matter 1: Scientific Writing, Citations, and Using Credible
Sources**
...
3.  Differentiate between primary, secondary, popular, and scholarly
    sources
...
10. Use writing practices that improve clarity, accuracy, and
    credibility
...
**Table 1. Comparison of Popular and Scholarly Sources in Scientific
Research**
...
scientific journals like *Science* and *Nature*.
...
Scientific writing emphasizes **clarity**, **precision**, and
**conciseness** to ensure that ideas and findings are communicated
...
particularly scholarly and peer-reviewed materials. Students learn to
differentiate between primary and secondary sources and to evaluate
credibility using criteria such as the CRAAP test. This ensures that
conclusions are based on accurate, unbiased, and scientifically valid
information.

Equally important is the ethical use of information. Proper **citation
practices** allow students to give credit to original researchers, avoid
plagiarism, and strengthen the credibility of their work. Using
consistent citation formats such as APA or CSE helps maintain
professional standards in scientific communication.

The chapter also introduces **scientific writing**, which prioritizes
clarity, precision, and conciseness. Students learn the standard
structure of a scientific paper---including Introduction, Methods,
Results, and Discussion---and the purpose of each section. This
...
-   Use the **Introduction** to explain the scientific question and
...
-   Interpret findings in the **Discussion**, connecting results to
...
# **Appendix: Scientific Writing, Citations, and Credible Sources Terms**
  ...
  Term              Definition
  ----------------- -----------------------------------------------------
  Abstract          A brief summary of a scientific paper including
                    purpose, methods, results, and conclusions.

  Accuracy          The correctness of information, supported by evidence
                    and reliable sources.

  APA Style         A citation format that uses author and date for
                    referencing sources.

  Authority         The credibility and qualifications of an author or
                    source.

  Bias              A tendency to present information in a non-objective
                    or unfair way.
  ...
  CSE Style         A citation format commonly used in biology that
                    emphasizes author and year.

  Discussion        A section of a scientific paper that interprets
                    results and explains their significance.
  ...
  Methods           The section describing how an experiment was
                    conducted.

  Peer Review       The evaluation of scientific work by experts before
                    publication.

  Plagiarism        Using another person's work or ideas without giving
                    proper credit.

  Precision         Using exact and accurate language in scientific
                    writing.
  ...
  Results           The section that presents data without
                    interpretation.

  Scholarly Source  A peer-reviewed source written for a scientific
                    audience.

  Scientific        A question that can be tested through observation and
