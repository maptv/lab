...
Effective reading requires **active engagement**. This means you should
take your time, avoid skimming, and review the material more than once
if necessary to fully understand the concepts and procedures. Thoughtful
...
However, AI is **not a replacement for your own thinking or scientific
understanding**.
...
-   You are responsible for **verifying all information** and completing
    your own work
...
-   Verify all information using **textbooks or approved scientific
    sources**
...
Remember: success in this course depends on **preparation, critical
thinking, and academic integrity**. Responsible use of AI and
...
# **Appendix: Pre-Lab Preparation and Responsible Use of AI Terms**
  ...
  **Term**       **Definition**
  -------------- ---------------------------------------------------------
  Academic       Honest and ethical behavior in academic work.
  Integrity      

  Action Verb    A word that describes an action, used in lab objectives
                 (e.g., observe, measure).

  APA Format     A standardized citation style used to reference sources
                 in scientific writing.

  Artificial     Computer systems that can generate text, analyze
  Intelligence   information, or assist with learning tasks.
  (AI)           

  Checklist      A list used to ensure all required steps or components
                 are completed.
  ...
  Credible       A reliable and trustworthy source of scientific
  Source         information.

  Dependent      The variable that is measured or observed in an
  Variable       experiment.

  Experimental   The plan for conducting an experiment and testing a
  Design         hypothesis.

  Hypothesis     An educated prediction that can be tested through
                 experimentation.

  Independent    The variable that is changed or manipulated in an
  Variable       experiment.
  ...
  Pre-Lab        The process of reviewing material before conducting an
  ...
  Responsible AI Using AI tools ethically to support learning without
  Use            replacing original work.

  Scientific     Using logic and evidence to explain scientific ideas.
  Reasoning      

  Source         The process of determining whether a source is reliable
  Evaluation     and accurate.

  Study Question A question used to guide understanding before or during a
                 lab.
  ...
  Writing        The ability to express ideas clearly and effectively.
  Clarity        
  ------------------------------------------------------------------------
