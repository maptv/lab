...
| 4 | Saltatory conduction depends on the presence of, which are gaps through which ions in the extracellular fluid can reach the neuron's plasma membrane. (5,2,7) |
...
| 3\. | The is a long cytoplasmic process that uniformly maintains its diameter. |
...
| 7\. | The is the area of rough endoplasmic reticulum located in the neuron cell body. Proteins are manufactured here. |
| 8\. | are extensions of an axon that form synapses with other neurons. |
